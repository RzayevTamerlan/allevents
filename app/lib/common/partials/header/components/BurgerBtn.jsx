...
const BurgerBtn = () => {
  ...
  return (
    <button aria-label='Toggle Burger' onClick={handleClick} className={`w-6 ${isOpen ? 'translate-y-2' : 'translate-y-0'} transition-all duration-75 lg:hidden flex h-4 flex-col justify-between`}>
